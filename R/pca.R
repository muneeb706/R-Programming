...
pacman::p_depends(psych)     # Check dependencies for psych
pacman::p_load(GPArotation)  # Install dependency

# LOAD DATA ################################################

# Read big5.csv from desktop
b5 <- read.csv(paste(getwd(),"/data/linkedin_learning/b5.csv",sep=""), header = T) 
